# backend1/b2b/views/missions.py
# -*- coding: utf-8 -*-
...
from b2b.models import Mission, MissionRessource, OrdreMission, Vehicule, Chauffeur
from b2b.serializers import MissionSerializer
from b2b.views.helpers import _user_role
