...
def forwards(apps, schema_editor):
    ...
    # (optionnel mais recommandé) index
    # si tu veux éviter l’erreur si l’index existe déjà, on le fait en try
    try:
...
class Migration(migrations.Migration):
    dependencies = [
        ("b2b", "0045_remove_historiquetransformation_fiche_de_mouvement_and_more"),
    ]
